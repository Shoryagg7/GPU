// Q6: Even-odd sort using shared memory, data generated with CURAND
#include <cstdio>
#include <cstdlib>
...
__global__ void even_odd_sort(float *data, int n) {
...
int main() {
    ...
    CHECK_CURAND(curandSetPseudoRandomGeneratorSeed(gen, 91011ULL));
    ...
    even_odd_sort<<<1, N, N * sizeof(float)>>>(d_data, N);
    ...
    printf("Even-odd sort kernel time: %.3f ms\n", kernelMs);
